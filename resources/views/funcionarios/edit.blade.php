                ...
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telefone" id="telefone" class="form-input mt-1 block w-full" value="{{ $funcionario->telefone }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="data_contratacao" id="data_contratacao" class="form-input mt-1 block w-full" value="{{ $funcionario->data_contratacao }}" required>
                        </div>
